...
//xSofU7Fv1u6nN5H2 ${process.env.DB_PASSWORD}
//${mongoUser} sls-mongo-example
var DBurl = `mongodb+srv://sls-mongo-example:xSofU7Fv1u6nN5H2@withawslambda.7aehv.mongodb.net/test?retryWrites=true&w=majority`;
